...
class ProfileController extends Controller implements ProfilePageInterface
{
    ...
    public function create(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $user = Users::create(Arr::only($data, ['cid', 'name', 'email', 'role', 'password',
    ...
    public function restore(Request $request): JsonResponse|bool
    {
        ...
        try {
            DB::beginTransaction();
            $user = Users::where('email', $data['email'])->where('name', $data['name'])->first();
            ...
            if ($user) {
                ...
                if ($oneTimeToken) {
                    $name = $user->name;
                    $template = view('mail.restore', compact('name', 'generatedToken'))->render();
    ...
    public function sendEmailVerify(Request $request): JsonResponse|bool
    {
        ...
        $name = $data['name'];
        $template = view('mail::mail.verify', compact('name', 'token'))->render();
